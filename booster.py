...
CMDS = {
    ...
    'output_power_transform': {
        'nargs': 2,
        'type': float,
        'help': 'Specify the output power transform in the provided <slope>,<offset> (`power_dBm = slope*input_Volt + offset`)',
    },
    'reflected_power_transform': {
        'nargs': 2,
        'type': float,
        'help': 'Specify the reflfected power transform in the provided <slope>,<offset> (`power_dBm = slope*input_Volt + offset`)',
    },
    'read': {
        'nargs': 1,
